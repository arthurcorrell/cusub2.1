...
**cortex.behavior** contains custom BT behaviors. These subclass BehaviorTree.Action. Each custom behavior needs a name and an action, which is defined in it's scope. The action function should return True if everything executes correctly .
